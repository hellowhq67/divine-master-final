    ...
    async function fetchData() {
      ...
      try {
        const [totalProductsResponse, productsResponse] = await Promise.all([
          ...
          axios.get(`/api/admin/${category}?page=${page}&limit=${itemsPerPage}`)
        ]);
        ...
        setTotalPages(productsResponse.data.totalPages || totalPagesCount); // Either use API totalPages or calculated pages
      } catch (error) {
        setError(error);
      } finally {
