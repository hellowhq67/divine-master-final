...
import { toast, ToastContainer, toastConteiner } from "react-toastify";
export default function Registration() {
  const { user, googleSignIn, createAccountWithEmail, facebookSignIn } =
    UseAuth();
  ...
  const handelSingUp = async () => {
    try {
      const isSignedUp = await createAccountWithEmail(email, password, name);
              ...
              <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                <div class="mt-12 flex flex-col items-center">
                  ...
                  <div class="w-full flex-1 mt-8">
                    ...
                    <span className="text-center">Already Have An Account? <Link className="underline" href={'/login'}>Sign In</Link></span>
                    </div>
                    </form>
