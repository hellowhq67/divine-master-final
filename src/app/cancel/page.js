        ...
        <>
            ...
            <div className="flex justify-center items-center h-screen bg-gray-100">
                <div className="text-center bg-white p-6 rounded-lg shadow-md">
                    <img className="w-24 mx-auto mb-4" src="https://cdn-icons-png.flaticon.com/256/5268/5268671.png" alt="Payment Failed" />
                    <h6 className="text-lg font-semibold text-red-600 mb-2">Payment Cancelled</h6>
                    <Link href="/">
